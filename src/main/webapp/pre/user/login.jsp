...
<body>  
		...
		<div class="login">
			...
			<div class="log_c">
	            ...
	            <table border="0" style="width:370px; font-size:14px; margin-top:30px;" cellspacing="0" cellpadding="0">
	              ...
	              <tr><td colspan="2"><span id="info" style="color:red"></span></td></tr>
	              <tr>
	              	<td>&nbsp;</td>
	              ...
	              <tr height="60">
	              	<td>&nbsp;</td>
	                <td><input type="button" value="登录" class="log_btn" id="submit" /></td>
	              </tr>
	            </table>
	...
	<div class="btmbg">
	    <div class="btm">
	        备案/许可证编号：蜀ICP备12009302号-1 Copyright © 2015-2018 尤洪商城网 All Rights Reserved. 复制必究 , Technical Support: Dgg Group <br />
	        <img src="../../statics/images/b_1.gif" width="98" height="33" />
	        <img src="../../statics/images/b_2.gif" width="98" height="33" />
	        <img src="../../statics/images/b_3.gif" width="98" height="33" />
	        <img src="../../statics/images/b_4.gif" width="98" height="33" />
	        <img src="../../statics/images/b_5.gif" width="98" height="33" />
	        <img src="../../statics/images/b_6.gif" width="98" height="33" />
	    </div>    	
	</div>
	<!--End Footer End -->    
